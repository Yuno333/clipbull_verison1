...
const mockDisputes = [
  { id: "101", reporter: "Nike Official", target: "John_Earner", reason: "AI Generated Content", priority: "high", status: "open", date: "2 hours ago" },
  ...
  { id: "104", reporter: "Tech Reviewer", target: "Earner_X", reason: "Policy Violation", priority: "high", status: "open", date: "10 mins ago" },
];

import { useTitle } from "@/lib/title-context";

export default function DisputesPage() {
  useTitle("Resolution Center", "Review and resolve disputes between creators and earners.");
    ...
    <div className="p-8 pb-20">
      ...
      >
        <div className="opacity-0 h-0 overflow-hidden absolute">
          ...
          <p className="text-zinc-400 text-sm">Review and resolve disputes between creators and earners.</p>
        </div>
