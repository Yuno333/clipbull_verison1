  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        const rawRole = data.user.app_metadata?.role || data.user.user_metadata?.role || "creator";
        const role = rawRole === "clipper" ? "earner" : rawRole;
    ...
    <div className="min-h-screen flex items-center justify-center px-6 relative z-10">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-zinc-500">Log in to your TUKKA account</p>
        </div>
