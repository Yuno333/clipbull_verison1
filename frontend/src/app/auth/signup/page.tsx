...
const roleContent = {
  creator: {
    ...
    benefits: [
      ...
      { icon: Users, text: "Access to thousands of vetted earners" },
  ...
  earner: {
    ...
    benefits: [
      ...
      {
        icon: Users,
        text: "Join a community of top earners",
      },
    ],
...
function SignUpForm() {
  ...
  const initialRole = requestedRole === "earner" || requestedRole === "clipper" ? "earner" : "creator";

  const [role, setRole] = useState<"creator" | "earner">(initialRole);
  ...
  useEffect(() => {
    ...
    if (r === "earner" || r === "clipper" || r === "creator") {
      setRole(r === "clipper" ? "earner" : r);
    }
  }, [searchParams]);
