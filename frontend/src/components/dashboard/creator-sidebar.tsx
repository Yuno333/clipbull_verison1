...
const navItems = [
  ...
  { label: "Wallet & Payments", href: "/dashboard/creator/wallet", icon: Wallet },
  { label: "Performance Reports", href: "/dashboard/creator/reports", icon: BarChart3 },
  { label: "Disputes", href: "/dashboard/creator/disputes", icon: AlertTriangle },
    ...
    <div className="flex flex-col h-full surface border-r border-white/5 w-[260px] relative">
      ...
      <div className="px-6 py-6 border-b border-white/5 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-primary flex items-center justify-center hover-lift">
            ...
            >
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-primary/10 text-primary shadow-[inset_0_0_12px_rgba(124,58,237,0.05)]"
              ...
              >
                {isActive && (
                  <motion.div
                    ...
                    className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-5 bg-primary rounded-r-full shadow-[0_0_10px_rgba(124,58,237,0.6)]"
      ...
      <div className="p-4 bg-white/[0.02] border-t border-white/5 mt-auto">
        <div className="flex items-center gap-3 p-3 rounded-2xl bg-white/[0.03] border border-white/5 mb-3 group transition-all hover:bg-white/[0.05]">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-purple-400 flex items-center justify-center text-xs font-bold text-white shrink-0 shadow-lg">
            {userInitials}
          </div>
