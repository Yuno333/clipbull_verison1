...
const testimonials = [
  {
    quote:
      "ClipBull completely automated my distribution. I went from 10k to 500k views in a month just by letting earners do their thing.",
    author: "Jason Davis",
  ...
  {
    quote:
      "As an earner, this is the easiest way to find high-quality content and get paid fairly. The platform is transparent and the payments are fast.",
    author: "Sarah Miller",
    role: "Top Rated Earner",
    avatar: "SM",
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        >
          ...
          <p className="text-zinc-500 text-base max-w-md mx-auto">
            Join thousands of creators and earners scaling their reach and
            revenue.
          </p>
        </motion.div>
